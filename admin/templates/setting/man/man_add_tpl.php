            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php if (isset($config['setting']['messenger']) && $config['setting']['messenger'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            <label for="messenger">Tên người dùng (vd: www.facebook.com/Tên người dùng/):</label>
                            <input type="text" class="form-control text-sm" name="data[options][messenger]" id="messenger" placeholder="Tên người dùng facebook" value="<?= (!empty($flash->has('messenger'))) ? $flash->get('messenger') : @$options['messenger'] ?>">
                        </div>
                    <?php } ?>
