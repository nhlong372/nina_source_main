    ...
    if (count($video_home)) { ?>
        <div class="video-main">
            <div class="youtube-player" data-video-id="<?= $func->getYoutube($video_home[0]['link_video']) ?>">
                <img class="btn-player" src="assets/images/icon-video.png" alt="" class="youtube-player">
                <img class="swiper-lazy" onerror="this.src='<?=THUMBS?>/504x282x1/assets/images/noimage.png';" src="<?=THUMBS?>/504x282x1/<?= UPLOAD_PHOTO_L . $video_home[0]['photo'] ?>"  alt="" title="" />
            </div>
        </div>
        <div class="video-list">
            <select class="listvideos">
