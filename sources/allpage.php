...
//          } 
//          else {
//              $func->transfer("Gửi đăng ký nhận tin thất bại. Vui lòng thử lại sau.", $configBase, false);
//          }
...
//              $strThongtin .= '<b>Số điện thoại: </b>' . $emailer->get('dienthoainguoigui') . '';
//          }
...
//          /* Send email admin */
//          $arrayEmail = null;
//          $subject = "Thư đăng ký nhận tin từ " . $data['fullname'];
//          //$setting['name' . $lang]
...
//              echo $func->transfer("Gửi đăng ký nhận tin thành công", $configBase);
//          } else $func->transfer("Gửi đăng ký nhận tin thất bại. Vui lòng thử lại sau", $configBase, false);
//      } else {
//          $func->transfer("Gửi đăng ký nhận tin thất bại. Vui lòng thử lại sau", $configBase, false);
//      }
//  }